...
public class FirstWeatherFragment extends Fragment {
	...
	public void updateWeather(List<F1> weatherinfo) {
		if (weatherinfo != null) {
			...
			int climate1 = Integer.parseInt(weatherinfo.get(1).getfa());
			int climate2 = Integer.parseInt(weatherinfo.get(1).getfb());
			if (climate1 > 31) {
			...
			temperatureTv1.setText(weatherinfo.get(1).getfd() + "~" + weatherinfo.get(1).getfc() + "℃");

			int wind_s = Integer.parseInt(weatherinfo.get(1).getfe());
